...
const QuoteForm = () => {
    return (
        ...
        <div className="w-full min-w-4xl mx-auto rounded-3xl shadow-2xl my-20 overflow-hidden bg-gradient-to-br from-blue-700 via-indigo-800 to-purple-900 transition-all duration-300 hover:-translate-y-3 hover:shadow-2xl">
            <div className="p-8 md:p-12">
                <div className="mb-10 text-center md:text-left">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-center md:text-left text-white mb-2">
                        Get Your Custom Quotation
                    </h2>
                    <p className="text-blue-100 text-lg font-medium opacity-90">
                        Please fill out the details below and our team will get back to you within 24 hours.
                    </p>
                    <div className="h-1.5 w-24 bg-white/30 mt-4 rounded-full mx-auto md:mx-0"></div>
                </div>

                <form className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    {/* Your Name */}
                    <div className="flex flex-col group">
                        <label className="text-sm font-bold text-blue-50 mb-2 transition-colors group-focus-within:text-white">
                            Your Name <span className="text-red-400">*</span>
                        </label>
                        <input
                            type="text"
                            required
                            className="w-full bg-white/10 border-2 border-white/10 rounded-xl px-4 py-3 text-white outline-none transition-all focus:border-white/40 focus:bg-white/20 placeholder:text-blue-200/50"
                    ...
                    <div className="flex flex-col group">
                        ...
                        <input
                            type="tel"
                            required
                            className="w-full bg-white/10 border-2 border-white/10 rounded-xl px-4 py-3 text-white outline-none transition-all focus:border-blue-300 focus:bg-white/20 placeholder:text-blue-200/50"
                    ...
                    <div className="flex flex-col group">
                        ...
                        <div className="relative">
                            <select
                                required
                                className="w-full bg-white/10 border-2 border-white/10 rounded-xl px-4 py-3 text-white outline-none transition-all focus:border-white/40 focus:bg-white/20 cursor-pointer appearance-none"
                            >
                    ...
                    <div className="flex flex-col md:col-span-2 group">
                        ...
                        <textarea
                            required
                            rows="5"
                            className="w-full bg-white/10 border-2 border-white/10 rounded-xl px-4 py-3 text-white outline-none transition-all focus:border-white/40 focus:bg-white/20 placeholder:text-blue-200/50 resize-none"
                    ...
                    <div className="md:col-span-2 flex justify-center md:justify-end mt-4">
                        <button
                            type="submit"
                            className="group relative inline-flex items-center justify-center px-12 py-4 font-bold text-blue-900 transition-all duration-200 bg-white rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white hover:bg-blue-50 shadow-xl active:scale-95"
                        >
                            Send Request
