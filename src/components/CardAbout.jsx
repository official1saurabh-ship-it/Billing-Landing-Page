...
const CardAbout = ({ comment, name, paragraph }) => {
    return (
        <div className="min-h-[250px] w-full max-w-[280px] md:max-w-[200px] flex flex-col bg-white  p-4 md:p-6 rounded-[2rem] justify-center items-center shadow-lg border border-gray-50 hover:shadow-xl transition-all duration-300">
