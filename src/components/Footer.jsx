...
const Footer = () => {
  return (
    <footer className="bg-[#111111] text-gray-300 py-16 px-6 md:px-[10%] font-sans transition-colors duration-300">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        
        {/* Column 1: Newsletter */}
        <div className="flex flex-col gap-6">
          <h3 className="text-white text-xl font-bold border-b-2 border-blue-500 w-fit pb-1">Newsletter</h3>
          ...
          <div className="relative mt-2">
            <input 
              ...
              className="w-full bg-[#222222] border border-gray-700 rounded-full py-3 px-5 focus:outline-none focus:border-blue-500 text-sm transition-colors text-white"
            />
        ...
        {/* Column 2: Explore */}
        <div className="flex flex-col gap-6">
          <h3 className="text-white text-xl font-bold border-b-2 border-blue-500 w-fit pb-1">Explore</h3>
        ...
        <div className="flex flex-col gap-6">
          <h3 className="text-white text-xl font-bold border-b-2 border-blue-500 w-fit pb-1">Contact Info</h3>
          ...
          <div className="flex gap-4 mt-2">
            <a href="#" className="p-2 bg-[#222222] rounded-full hover:bg-blue-600 hover:text-white transition-all text-gray-300">
        ...
        <div className="flex flex-col gap-6">
          <h3 className="text-white text-xl font-bold border-b-2 border-blue-500 w-fit pb-1">Popular Post</h3>
