...
const AboutUsPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
            ...
            <div className='flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-24 pt-[160px] md:pt-[200px] pb-20 gap-12 lg:gap-24 items-center'>
                ...
                >
                    <div className='grid grid-cols-2 gap-4 md:gap-8'>
                        {[
                            { color: "orange", label: "Elite Engineering", icon: <path d="m18 16 4-4-4-4"></path> },
                            { color: "orange", label: "Cloud Solution", icon: <path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"></path> },
                            { color: "amber", label: "Secure Architecture", icon: <path d="m9 12 2 2 4-4"></path> },
                            { color: "orange", label: "24/7 Support", icon: <path d="M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 18 0v7a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3"></path> }
                        ].map((item, i) => (
                            <div key={i} style={{ transform: "translateZ(30px)" }} className={`group flex flex-col items-center p-6 md:p-8 bg-white rounded-3xl shadow-xl border border-gray-50 hover:border-${item.color === 'orange' ? 'primary' : item.color}-500/30 transition-all duration-300`}>
                                <div className={`w-12 h-12 md:w-16 md:h-16 bg-${item.color}-50 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={`text-${item.color === 'orange' ? 'primary' : item.color + '-600'} md:w-8 md:h-8`}>
            ...
            <div className='w-full bg-gradient-to-r from-amber-500 via-orange-600 to-orange-500 bg-clip-text text-transparent font-black text-3xl md:text-6xl leading-tight text-center mt-10 mb-2 px-4'>From Vision to Reality</div>
            ...
            <section className="py-20 md:py-32 px-4 bg-gray-50">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-20">
                        <span className="text-primary font-black uppercase tracking-[0.2em] text-sm block mb-4">Why Choose Biosoftech</span>
                        <h2 className="text-3xl md:text-6xl font-black mb-8 text-gray-900 leading-tight">Your Partner in <span className="text-primary">Reliable IT Solutions</span></h2>
